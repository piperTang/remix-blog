...
function $1dbecbe27a04f9af$export$14d238f342723f25(defaultValue) {
  let [value, setValue] = (0, import_react7.useState)(defaultValue);
  let effect = (0, import_react7.useRef)(null);
...
function $bdb11010cef70236$export$f680877a34711e37(defaultId) {
  let [value, setValue] = (0, import_react8.useState)(defaultId);
...
function $bdb11010cef70236$export$b4cc09c592e8fdb8(depArray = []) {
  ...
  let updateId = (0, import_react8.useCallback)(() => {
...
var $ea8dcbcb9ea1b556$var$RouterContext = /* @__PURE__ */ (0, import_react9.createContext)({
  isNative: true,
...
function $ea8dcbcb9ea1b556$export$323e4fc2fa4753fb(props) {
  ...
  let ctx = (0, import_react9.useMemo)(() => ({
    isNative: false,
  ...
  return /* @__PURE__ */ (0, import_react9.default).createElement($ea8dcbcb9ea1b556$var$RouterContext.Provider, {
    value: ctx
  }, children);
}
function $ea8dcbcb9ea1b556$export$9a302a45f65d0572() {
  return (0, import_react9.useContext)($ea8dcbcb9ea1b556$var$RouterContext);
}
...
function $99facab73266f662$export$5add1d006293d136(ref, initialValue, onReset) {
  let resetValue = (0, import_react11.useRef)(initialValue);
...
function useVisualElement(Component2, visualState, props, createVisualElement, ProjectionNodeConstructor) {
  ...
  const visualElementRef = (0, import_react20.useRef)();
  ...
  const wantsHandoff = (0, import_react20.useRef)(Boolean(props[optimizedAppearDataAttribute] && !window.HandoffComplete));
...
function useCreateMotionContext(props) {
  const { initial, animate } = getCurrentTreeVariants(props, (0, import_react22.useContext)(MotionContext));
  return (0, import_react22.useMemo)(() => ({ initial, animate }), [variantLabelsAsDependency(initial), variantLabelsAsDependency(animate)]);
}
...
var LayoutGroupContext = (0, import_react23.createContext)({});
...
var createDomVisualElement = (Component2, options) => {
  return isSVGComponent(Component2) ? new SVGVisualElement(options) : new HTMLVisualElement(options, {
    allowProjection: Component2 !== import_react30.Fragment
  });
};
...
function useForceUpdate() {
  ...
  const [forcedRenderCount, setForcedRenderCount] = (0, import_react32.useState)(0);
  const forceRender = (0, import_react32.useCallback)(() => {
    isMounted.current && setForcedRenderCount(forcedRenderCount + 1);
  }, [forcedRenderCount]);
  const deferredForceRender = (0, import_react32.useCallback)(() => frame.postRender(forceRender), [forceRender]);
...
function PopChild({ children, isPresent }) {
  ...
  const size = (0, import_react33.useRef)({
    width: 0,
    height: 0,
    top: 0,
    left: 0
  });
  const { nonce } = (0, import_react33.useContext)(MotionConfigContext);
  ...
  return (0, import_jsx_runtime2.jsx)(PopChildMeasure, { isPresent, childRef: ref, sizeRef: size, children: React2.cloneElement(children, { ref }) });
}

// node_modules/framer-motion/dist/es/components/AnimatePresence/PresenceChild.mjs
var PresenceChild = ({ children, initial, isPresent, onExitComplete, custom, presenceAffectsLayout, mode }) => {
  const presenceChildren = useConstant(newChildrenMap);
  const id2 = (0, import_react34.useId)();
...
function onlyElements(children) {
  const filtered = [];
  import_react36.Children.forEach(children, (child) => {
...
var AnimatePresence = ({ children, custom, initial = true, onExitComplete, exitBeforeEnter, presenceAffectsLayout = true, mode = "sync" }) => {
  ...
  const forceRender = (0, import_react36.useContext)(LayoutGroupContext).forceRender || useForceUpdate()[0];
  const isMounted = useIsMounted();
  const filteredChildren = onlyElements(children);
  let childrenToRender = filteredChildren;
  const exitingChildren = (0, import_react36.useRef)(/* @__PURE__ */ new Map()).current;
  const presentChildren = (0, import_react36.useRef)(childrenToRender);
  const allChildren = (0, import_react36.useRef)(/* @__PURE__ */ new Map()).current;
  const isInitialRender = (0, import_react36.useRef)(true);
  useIsomorphicLayoutEffect(() => {
  ...
  return (0, import_jsx_runtime4.jsx)(import_jsx_runtime4.Fragment, { children: exitingChildren.size ? childrenToRender : childrenToRender.map((child) => (0, import_react36.cloneElement)(child)) });
};
...
function LazyMotion({ children, features, strict = false }) {
  const [, setIsLoaded] = (0, import_react37.useState)(!isLazyBundle(features));
  const loadedRenderer = (0, import_react37.useRef)(void 0);
...
var NextUIProvider = ({
  ...
  if (navigate) {
    contents = /* @__PURE__ */ (0, import_jsx_runtime6.jsx)($ea8dcbcb9ea1b556$export$323e4fc2fa4753fb, { navigate, children: contents });
  }
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ProviderContext, { value: context, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)($18f2051aff69b9bf$export$a54013f0d02a8f82, { locale, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)($f57aed4a881a3485$export$bf688221f59024e5, { ...otherProps, children: contents }) }) });
};
...
//# sourceMappingURL=/build/_shared/chunk-FRWKYVEH.js.map
